...
AUDIOS = [

    {
        ...
        "wav": "C:\\Users\\vitor\\OneDrive\\Área de Trabalho\\IFBA\\IA\\reconhecimento_de_fala\\audios\\ligar lampada.wav"
    },

    {
        "comando": "desligar a lâmpada",
        "wav": "C:\\Users\\vitor\\OneDrive\\Área de Trabalho\\IFBA\\IA\\reconhecimento_de_fala\\audios\\desligar lampada.wav"
    },

]

def iniciar_modelo(nome_modelo, despositivo="cpu"):
    ...
    try:
        ...
        modelo = Wav2Vec2ForCTC.from_pretrained(nome_modelo).to(despositivo)
